...
const allAthletes = [
    ...
    { name: 'Iva Juranovic', nation: 'HRV', team: 'Pünki Star' },
    { name: 'Blubbi Kreischeling', nation: 'FJI', team: 'Little Fly' },
    { name: 'Lolli Sweeting', nation: 'ITA', team: 'Fire and Ice' },
...
const standingsData = {
    overall: [
        ...
        { name: 'Iva Juranovic', nation: 'HRV', team: 'Pünki Star', points: 757, comps: 29 },
        { name: 'Blubbi Kreischeling', nation: 'FJI', team: 'Little Fly', points: 749, comps: 29 },
        { name: 'Lolli Sweeting', nation: 'ITA', team: 'Fire and Ice', points: 709, comps: 29 },
    ...
    madzn: [
        { name: 'Iva Juranovic', nation: 'HRV', team: 'Pünki Star', points: 849.3, comps: 4 },
        ...
        { name: 'Lolli Sweeting', nation: 'ITA', team: 'Fire and Ice', points: 583.3, comps: 4 },
